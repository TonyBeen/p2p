...
#define EULAR_BIG_ENDIAN       1   // 大端
#define EULAR_LITTLE_ENDIAN    2   // 小端

#if BYTE_ORDER == BIG_ENDIAN
#define EULAR_BYTE_ORDER EULAR_BIG_ENDIAN
#else
#define EULAR_BYTE_ORDER EULAR_LITTLE_ENDIAN
#endif

#if EULAR_BYTE_ORDER == EULAR_BIG_ENDIAN
#define LOCAL_HOST_BIG_ENDIAN
#endif
